...
var _ ipldfmt.NodeGetter = (*nodeGetter)(nil)

func NewNodeGetter(locator locator.Locator, retriever Retriever, space did.DID) *nodeGetter {
	return &nodeGetter{
		locator:   locator,
		retriever: retriever,
		space:     space,
...
func (d *nodeGetter) Get(ctx context.Context, c cid.Cid) (ipldfmt.Node, error) {
...
func (d *nodeGetter) GetMany(context.Context, []cid.Cid) <-chan *ipldfmt.NodeOption {
