...
type Repo interface {
	...
	// ShardsForUploadByState retrieves shards for an upload in a given state.
	ShardsForUploadByState(ctx context.Context, uploadID id.UploadID, state shardsmodel.ShardState) ([]*shardsmodel.Shard, error)
}
